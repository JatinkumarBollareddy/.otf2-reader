...
cpu=[];m1=[];m3=[];m2=[];m4=[];m5=[];m6=[];m7=[];m_t=[];p=[];p_t=[];l=[];cpu_t=[];f=[];f_t=[];
...
cpu_t=np.array(cpu_t); p_t=np.array(p_t); p=np.array(p); f=np.array(f);     f_t=np.array(f_t);
...
workbook = xlsxwriter.Workbook('Experiment4.xlsx')
